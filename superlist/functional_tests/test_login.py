...
class LoginTest(FunctionalTest):
    ...
    def test_can_get_email_link_to_log_in(self):
        ...
        # Эдит заходит на офигительный сайт суперсписков и впервые змечает раздел "Войти"
        ...
        # Появляется сообщение, которое говорит, что на почту было выслоно электронное письмо
