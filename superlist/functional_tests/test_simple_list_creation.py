...
class NewVisitorTest(FunctionalTest):
    ...
    def test_can_start_a_list_for_one_user(self):
        ...
        self.wait_for_row_in_list_table('1: Купить павлиньи перья')
        self.wait_for_row_in_list_table('2: Сделать мушку и павлиньих перьев')
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        ## Мы используем новый сеанс браузера, тем самым обеспечивая, чтобы никакая информация от
        ## Эдит не прошла через cookie и пр.
        self.browser.quit()
        ...
        self.assertNotIn('Сделать мушку и павлиньих перьев', page_text)
